...
objects in interoperable file formats*. R package version 0.99.1,
<https://github.com/RforMassSpectrometry/SpectraStash>.

@Manual{, title = {SpectraStash: Serialize and restore Spectra objects
in interoperable file formats}, author = {Johannes Rainer and Philippine
Louail}, year = {2026}, note = {R package version 0.99.1}, url =
{https://github.com/RforMassSpectrometry/SpectraStash}, }
